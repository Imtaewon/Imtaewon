# 💻 점이 아닌 계를 설계하는 개발자, 임태원입니다.

## 🔍 Profile

금융 API 연동부터 실시간 SSE 스트리밍 인프라 구축까지, 서비스 전 영역을 다뤄본 경험을 통해 가장 견고하고 효율적인 기술 토대를 설계하겠습니다.
...
**삼성 SW/AI 아카데미(SSAFY) 13기 (2025.01 - 2025.12)**
- **기간**: 총 1년, 주 40시간 집중 교육
- **핵심 습득 내용**: 
    - 집중 교육: 주 40시간, 총 1,600시간 이상의 알고리즘 및 풀스택(FastAPI, React) 심화 교육 이수

    - 협업 프로세스: Agile 방법론 기반 스크럼 수행, Jira를 활용한 업무 구조화 및 Git 브랜치 전략 숙달

    - 인프라 최적화: Docker 기반 컨테이너라이징 및 CI/CD 파이프라인 구축을 통한 배포 자동화 경험



**신한은행 금융 해커톤 본선 (2025.08)**

- **프로젝트**: 게이미피케이션 기반 대학생 자산 관리 서비스 '쏠쏠한 퀘스트' 개발
- **시스템 설계**: FastAPI 기반의 8개 독립 도메인 모듈(Auth, Quests, Accounts 등) 설계 및 Router-Service 패턴 적용으로 시스템 확장성 확보
- **비즈니스 인사이트**: 대학생 저축 동기부여 문제를 '금융 혜택과 일상 퀘스트의 결합'으로 풀어내며, 기술이 실제 금융 비즈니스 가치로 전환되는 메커니즘 체득
...
*팀 내 기여도는 약 60%로, 전체 백엔드 시스템과 인프라를 단독으로 담당하며 프로젝트의 기술적 토대를 구축했습니다.*
...
*팀 내 기여도는 약 40%로, 전체 프론트엔드 시스템을 단독으로 설계하고 구현하며 사용자 경험의 완성도를 책임졌습니다.*
